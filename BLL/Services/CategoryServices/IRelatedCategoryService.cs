...
namespace BLL.Services.CategoryService
{
    ...
    {
        Task<OperationResultModel<RelatedCategoryDBModel>> CreateAsync(RelatedCategoryRequestModel model);
        Task<OperationResultModel<RelatedCategoryDBModel>> UpdateAsync(RelatedCategoryUpdateRequestModel entity);
