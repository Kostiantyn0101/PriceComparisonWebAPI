...
namespace DLL.Migrations
{
    ...
    [Migration("20250316141934_VariantNameColumnInProductsDropped")]
    partial class VariantNameColumnInProductsDropped
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Models.DBModels.ProductDBModel", b =>
                {
                    ...
                    b.HasIndex("Id", "ProductGroupId", "ColorId")
                        .IsUnique()
                        .HasFilter("[ProductGroupId] IS NOT NULL AND [ColorId] IS NOT NULL");
