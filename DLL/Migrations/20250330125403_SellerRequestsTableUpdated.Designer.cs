...
namespace DLL.Migrations
{
    ...
    [Migration("20250330125403_SellerRequestsTableUpdated")]
    partial class SellerRequestsTableUpdated
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Models.DBModels.BaseProductDBModel", b =>
                {
                    ...
                    b.HasIndex("NormalizedTitle")
                        .HasDatabaseName("IX_BaseProduct_NormalizedTitle");
                    ...
                    b.ToTable("ProductCharacteristics", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_ProductCharacteristic_AtLeastOneValue", "(ValueText IS NOT NULL) OR (ValueNumber IS NOT NULL) OR (ValueBoolean IS NOT NULL) OR (ValueDate IS NOT NULL)");
                        });
                });
            ...
            modelBuilder.Entity("Domain.Models.DBModels.ProductDBModel", b =>
                {
                    ...
                    b.HasIndex("NormalizedModelNumber")
                        .HasDatabaseName("IX_Product_NormalizedModelNumber");

                    b.HasIndex("ProductGroupId");

                    b.HasIndex("Id", "ProductGroupId", "ColorId")
                        .IsUnique()
            ...
            modelBuilder.Entity("Domain.Models.DBModels.ProductGroupDBModel", b =>
                {
                    ...
                    b.HasIndex("NormalizedName")
                        .HasDatabaseName("IX_ProductGroup_NormalizedName");
            ...
            modelBuilder.Entity("Domain.Models.DBModels.ProductGroupTypeDBModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Models.DBModels.SellerDBModel", b =>
                {
                    ...
                    b.Property<bool>("PublishPriceList")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Domain.Models.DBModels.SellerRequestDBModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("StoreComment")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Domain.Models.DBModels.ProductDBModel", b =>
                {
                    ...
                    b.HasOne("Domain.Models.DBModels.ProductGroupDBModel", "ProductGroup")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Domain.Models.DBModels.ProductGroupDBModel", b =>
                {
                    b.HasOne("Domain.Models.DBModels.ProductGroupTypeDBModel", "ProductGroupType")
